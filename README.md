...
3. **Data Analysis:** Data Profiling section intended to generate reports (https://github.com/AnaPatSilva/Titanic-I/blob/main/Data%20Profiling/profile_train.pdf)
...
13. **Model Output:** The result of the adjusted model is saved in a CSV file (https://github.com/AnaPatSilva/Titanic-I/blob/main/Outputs/RF_GS%20(1f).csv).
